...
#define STM_TX_G0_Pin GPIO_PIN_2
#define STM_TX_G0_GPIO_Port GPIOA
#define STM_RX_G0_Pin GPIO_PIN_3
#define STM_RX_G0_GPIO_Port GPIOA
...
#define LED_G0_Pin GPIO_PIN_0
#define LED_G0_GPIO_Port GPIOB
#define POWER_KILL_Pin GPIO_PIN_1
#define POWER_KILL_GPIO_Port GPIOB
#define SPI1_SCK_DAC_Pin GPIO_PIN_3
#define SPI1_SCK_DAC_GPIO_Port GPIOB
#define STM_CC_CV_Pin GPIO_PIN_4
#define STM_CC_CV_GPIO_Port GPIOB
...
#define PGOOD_5VR_Pin GPIO_PIN_11
#define PGOOD_5VR_GPIO_Port GPIOA
#define SWDIO_G0_Pin GPIO_PIN_13
#define SWDIO_G0_GPIO_Port GPIOA
#define SWCLK_G0_Pin GPIO_PIN_14
#define SWCLK_G0_GPIO_Port GPIOA
#define STM_OUT_OFF_Pin GPIO_PIN_15
#define STM_OUT_OFF_GPIO_Port GPIOA
#define ADC_MCLK_Pin GPIO_PIN_7
#define ADC_MCLK_GPIO_Port GPIOC
...
/* Compatibility aliases for application code written against the previous pin names. */
#define PGOOD_5V_IN_Pin PGOOD_5VR_Pin
#define PGOOD_5V_IN_GPIO_Port PGOOD_5VR_GPIO_Port
#define CC_CV_STATE_Pin STM_CC_CV_Pin
#define CC_CV_STATE_GPIO_Port STM_CC_CV_GPIO_Port
#define OUT_OFF_Pin STM_OUT_OFF_Pin
#define OUT_OFF_GPIO_Port STM_OUT_OFF_GPIO_Port
