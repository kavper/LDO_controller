...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(OUT_OFF_GPIO_Port, OUT_OFF_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(BLEEDER_EN_GPIO_Port, BLEEDER_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PGOOD_5V_IN_Pin CC_CV_STATE_Pin */
  GPIO_InitStruct.Pin = PGOOD_5V_IN_Pin|CC_CV_STATE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : OUT_OFF_Pin */
  GPIO_InitStruct.Pin = OUT_OFF_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(OUT_OFF_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : BLEEDER_EN_Pin DAC_LDAC_Pin DAC_CLR_Pin */
  GPIO_InitStruct.Pin = BLEEDER_EN_Pin|DAC_LDAC_Pin|DAC_CLR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
